...
{
    public class HelloRequest:Message, IEquatable<HelloRequest>
    {
        ...
        public HelloRequest( Subscriber subscriber )
        {
            this.Subscriber = subscriber;
        }

        public HelloRequest( Subscriber subscriber, MessageId id )
        :
            base( id )
        {
            this.Subscriber = subscriber;
