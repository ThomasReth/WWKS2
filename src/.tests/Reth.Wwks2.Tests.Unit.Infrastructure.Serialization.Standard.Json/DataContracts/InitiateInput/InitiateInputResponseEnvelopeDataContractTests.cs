...
{
    public class InitiateInputResponseEnvelopeDataContractTests:JsonMessageTests
    {
        public static ( string Json, IMessageEnvelope Object ) Response
        {
            get
            {
                ...
                return (    $@" {{
                            ...
                            new MessageEnvelope<InitiateInputResponse>( new InitiateInputResponse(  JsonMessageTests.Source,
