...
{
    public class StockInfoResponseEnvelopeDataContractTests:JsonMessageTests
    {
        public static ( string Json, IMessageEnvelope Object ) Response
        {
            get
            {
                ...
                return (    $@" {{
                            ...
                            new MessageEnvelope<StockInfoResponse>( new StockInfoResponse(  JsonMessageTests.Source,
