...
{
    public class StockInfoMessageEnvelopeDataContractTests:JsonMessageTests
    {
        public static ( string Json, IMessageEnvelope Object ) Message
        {
            get
            {
                ...
                return (    $@" {{
                            ...
                            new MessageEnvelope<StockInfoMessage>(  new StockInfoMessage(   JsonMessageTests.Source,
