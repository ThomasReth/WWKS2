...
namespace Reth.Wwks2.Tests.Unit.TestData.Xml
{
    ...
    {
        public static ( string Xml, IMessageEnvelope Object ) HelloRequest
        {
            get
            {
                (   SubscriberId Id,
                ...
                return (    $@" <WWKS Version=""2.0"" TimeStamp=""{ MessageEnvelopeTestData.Timestamp }"">
                                    <HelloRequest Id=""{ MessageEnvelopeTestData.MessageId }"">
        ...
        public static ( string Xml, IMessageEnvelope Object ) KeepAliveRequest
        {
            ...
            {
                return (    $@" <WWKS Version=""2.0"" TimeStamp=""{ MessageEnvelopeTestData.Timestamp }"">
                                    <KeepAliveRequest Id=""{ MessageEnvelopeTestData.MessageId }"" Source=""{ MessageTestData.Source }"" Destination=""{ MessageTestData.Destination }"" />
                                </WWKS>",
