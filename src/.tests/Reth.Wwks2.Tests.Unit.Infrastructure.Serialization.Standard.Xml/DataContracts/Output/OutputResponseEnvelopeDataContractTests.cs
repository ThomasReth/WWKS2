...
{
    public class OutputResponseEnvelopeDataContractTests:XmlMessageTests
    {
        public static ( string Xml, IMessageEnvelope Object ) Response
        {
            get
            {
                ...
                return (    $@" <WWKS Version=""2.0"" TimeStamp=""{ XmlMessageTests.Timestamp }"">
                                    <OutputResponse Id=""{ XmlMessageTests.MessageId }""
                            ...
                            new MessageEnvelope<OutputResponse>(    new OutputResponse( XmlMessageTests.Source,
