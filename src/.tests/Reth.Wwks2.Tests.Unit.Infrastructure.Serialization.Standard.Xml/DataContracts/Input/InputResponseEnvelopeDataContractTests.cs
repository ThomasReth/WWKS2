...
{
    public class InputResponseEnvelopeDataContractTests:XmlMessageTests
    {
        public static ( string Xml, IMessageEnvelope Object ) Response
        {
            get
            {
                ...
                return (    $@" <WWKS Version=""2.0"" TimeStamp=""{ XmlMessageTests.Timestamp }"">
                                    <InputResponse  Id=""{ XmlMessageTests.MessageId }""
                                        ...
                                        <Article    Id=""{ article.Id }""
                                            ...
                                            <Pack   DeliveryNumber=""{ pack.DeliveryNumber }""
                            ...
                            new MessageEnvelope<InputResponse>( new InputResponse(  XmlMessageTests.Source,
