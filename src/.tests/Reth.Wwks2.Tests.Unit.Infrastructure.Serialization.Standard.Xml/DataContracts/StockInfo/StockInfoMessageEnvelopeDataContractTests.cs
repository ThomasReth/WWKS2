...
{
    public class StockInfoMessageEnvelopeDataContractTests:XmlMessageTests
    {
        public static ( string Xml, IMessageEnvelope Object ) Message
        {
            get
            {
                ...
                return (    $@" <WWKS Version=""2.0"" TimeStamp=""{ XmlMessageTests.Timestamp }"">
                                    <StockInfoMessage   Id=""{ XmlMessageTests.MessageId }""
                            ...
                            new MessageEnvelope<StockInfoMessage>(  new StockInfoMessage(   XmlMessageTests.Source,
        ...
        {
            bool result = base.SerializeMessage( StockInfoMessageEnvelopeDataContractTests.Message );
        ...
        {
            bool result = base.DeserializeMessage( StockInfoMessageEnvelopeDataContractTests.Message );
