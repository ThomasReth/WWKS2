...
{
    public class InitiateInputMessageEnvelopeDataContractTests:XmlMessageTests
    {
        public static ( string Xml, IMessageEnvelope Object ) Message
        {
            get
            {
                ...
                return (    $@" <WWKS Version=""2.0"" TimeStamp=""{ XmlMessageTests.Timestamp }"">
                                    <InitiateInputMessage   Id=""{ XmlMessageTests.MessageId }""
                                        ...
                                        <Article    Id=""{ article.Id }""
                                            ...
                                            <Pack   ScanCode=""{ pack.ScanCode }""
                                                ...
                                                <Error Type=""{ error.Type }"" Text=""{ error.Text }"" />
                                            </Pack>
                                        </Article>
                                    </InitiateInputMessage>
                                </WWKS>",
                            new MessageEnvelope<InitiateInputMessage>(  new InitiateInputMessage(   XmlMessageTests.Source,
