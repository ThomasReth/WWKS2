...
{
    public class TaskInfoResponseEnvelopeDataContractTests:XmlMessageTests
    {
        public static ( string Xml, IMessageEnvelope Object ) Response
        {
            get
            {
                ...
                return (    $@" <WWKS Version=""2.0"" TimeStamp=""{ XmlMessageTests.Timestamp }"">
                                    <TaskInfoResponse Id=""{ XmlMessageTests.MessageId }"" Source=""{ XmlMessageTests.Source }"" Destination=""{ XmlMessageTests.Destination }"">
                                        <Task Id=""{ taskInfo.Id }"" Type=""{ taskInfo.Type }"" Status=""{ taskInfo.Status }"">
                                            <Article Id=""{ article.Id }"" Quantity=""{ article.Quantity }"">
                                                <Pack   Id=""{ pack.Id }""
                            ...
                            new MessageEnvelope<TaskInfoResponse>(  new TaskInfoResponse(   XmlMessageTests.Source,
