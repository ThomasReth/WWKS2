...
namespace Reth.Wwks2.Infrastructure.Serialization
{
    ...
    public class MessageNotSupportedException:Exception
    {
        ...
        public MessageNotSupportedException( string message, Exception innerException )
        :
            base( message, innerException )
        {
        }

        protected MessageNotSupportedException( SerializationInfo info, StreamingContext context )
        :
            base( info, context )
        {
        }
