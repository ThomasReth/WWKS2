...
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.ArticleMasterSet;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.ConfigurationGet;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.Hello;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.InitiateInput;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.Input;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.KeepAlive;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.Output;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.Status;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.StockDeliverySet;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.StockInfo;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.StockLocationInfo;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.TaskCancel;
using Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts.TaskInfo;

namespace Reth.Wwks2.Infrastructure.Serialization.Standard.Json.DataContracts
{
    internal class JsonDataContractResolver:DataContractResolver
    {
        public JsonDataContractResolver()
        {
